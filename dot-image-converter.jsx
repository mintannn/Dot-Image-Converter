...
const DotImageConverter = () => {
  ...
  const canvasSize = 512; // キャンバスサイズを大きくして高解像度に対応
  ...
  return (
    <div className="p-4 max-w-md mx-auto">
      ...
      <div className="mb-4">
        <label className="block mb-2">解像度: {resolution}x{resolution}</label>
        <Slider
          min={16}
          max={256}
          step={16}
      ...
      <div className="mb-4">
        <label className="block mb-2">ドットサイズ: {dotSize.toFixed(2)}</label>
        <Slider
          min={0.1}
          max={1}
          step={0.05}
